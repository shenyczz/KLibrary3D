...
//【鼠标消息】
void AstudyDemo::OnMouseDown(WPARAM wParam, int x, int y)
{
	...
	Dx12Study::OnMouseDown(wParam, x, y);
}
void AstudyDemo::OnMouseUp(WPARAM wParam, int x, int y)
{
	Dx12Study::OnMouseUp(wParam, x, y);
}
void AstudyDemo::OnMouseMove(WPARAM wParam, int x, int y)
{
...
//【更新数据】
void AstudyDemo::Update()
{
	//UpdateCamera();
}

// 【渲染绘制】
void AstudyDemo::Draw()
{
