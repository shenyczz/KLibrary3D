...
namespace dx12
{
	class DX12LIBCOMMON_EXPORTS_CLASS DXColors
	{
	public:
		static const std::vector<float> ClearColorRGBA;

		static const std::vector<float> BLACK;
		static const std::vector<float> RED;
		static const std::vector<float> GREEN;
		static const std::vector<float> BLUE;
